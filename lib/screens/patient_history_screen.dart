  ...
  Widget build(BuildContext context) {
    final modules = [
      ...
      _HistoryModule(
        ...
        tint: AppColors.moduleColor(1).icon,
        bg: AppColors.moduleColor(1).background,
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => ReportsScreen(
      ...
      _HistoryModule(
        ...
        tint: AppColors.moduleColor(2).icon,
        bg: AppColors.moduleColor(2).background,
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(
      ...
      _HistoryModule(
        ...
        tint: AppColors.moduleColor(3).icon,
        bg: AppColors.moduleColor(3).background,
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(
